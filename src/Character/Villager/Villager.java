...
public abstract class Villager extends Unit
{
	...
	/** Flag marking whether the player is interacting with the villager (to stop repeats) */
     ...
     * @param avatar The Image used to represent the villager
     * @throws SlickException
     */
    public Villager(double x, double y, String name, Image avatar)
    throws SlickException
    {
	 ...
	 * @param world The game world, which holds the fonts to write with.
	 */
	public void renderDialogueBox(Graphics g)
	{
		...
		float barY = (float)this.getY() - this.getPhysHeight()/2 - healthBarHeight - dialogueBarHeight - 5;
		...
		float textY = barY + ( dialogueBarHeight - g.getFont().getHeight(this.getDialogueText()) ) / 2;
