...
import Inventory.InventoryQuest;
...
public class VillagerPrince extends Villager
{
	 ...
	 * 
	 * @param x Prince's x coordinate
	 * @param y Prince's y coordinate
	 * @param name The prince's name
	 * @throws SlickException
	 */
	public VillagerPrince(double x, double y, String name)
	throws SlickException
	{
	...
	public void interact(Unit target)
	{
		...
		if(target instanceof Player)
		{
			...
			{
				InventoryQuest elixir = (InventoryQuest)(target.getInventory().hasItem("Elixir of Life"));
