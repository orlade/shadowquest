...
public class VillagerShopkeeper extends Villager
{
	...
	/** Create shopkeeper
	 * 
	 * @param x The shopkeeper x coordinate
	 * @param y The shopkeeper y coordinate
	 * @param name The shopkeeper name
	 * @throws SlickException
	 */
	public VillagerShopkeeper(double x, double y, String name)
	throws SlickException
	{
