...
public class InventoryWeapon extends InventoryItem
{
	 ...
	 * @param avatar The graphical representation of the weapon
	 * @param bonuses The bonuses to be applied (if any)
	 * @param min The weapon's minimum damage 
	 * @param max The weapon's maximum damage
	 */
	public InventoryWeapon(String name, Image avatar, ArrayList<Bonus> bonuses, double min, double max)
	{
