...
public abstract class MapFactory
{
	 ...
	 *  
	 * @param width The width of the map (tiles)
	 * @param height The height of the map (tiles)
	 * @return The generated map
	 * @throws Exception 
	 */
	public static Map generateCave(int width, int height, boolean hasExit)
	throws Exception
	{
		...
		return new DungeonMap("assets/auto_dungeon.tmx", "assets", entranceX, entranceY, exitX, exitY);
	} 
