...
public class XMLMapWriter
{
	...
	/**
	 * Writes a given map to a .tmx file (TileD XML data file) to be read in by Slick
	 * 
	 * @param map The map to write
	 * @param w The XML writer to write with
	 * @throws IOException
	 */
	 ...
	 * @param w The XML writer to use
	 * @throws IOException
	 */
	private static void writeTilesetReference(String path, XMLWriter w)
	throws IOException
	{
		// Write the tileset element
	 ...
	 * 
	 * @param map The map to write the tiles of
	 * @param w The XML writer to use
	 * @throws IOException
	 */
