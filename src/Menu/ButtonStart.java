...
public class ButtonStart extends Button
{
	...
	{
		super("start", x, y, new Image("assets/menu/btn-play.png"),
							 new Image("assets/menu/btn-play-light.png"));
	}
	...
	{
		sbg.enterState(RPG.GPSMAIN, new FadeOutTransition(Color.black), new FadeInTransition(Color.black));
	}
