...
{	
     ...
     */
    public WorldItem(double x, double y, String name, Type type, Image avatar, ArrayList<Bonus> bonuses)
    throws SlickException
    {
	 ...
	 * @param g The Slick graphics object, used for drawing.
	 * @param gps Facade for the player
	 */
	public void renderSecondary(Graphics g, GameplayState gps)
	{
		if(gps.isShowItemBars() ||
				gps.getPlayer().getPickupCandidate() != null &&
	 ...
	 * @param gps The GameplayState from which to remove the item
	 */
	...
	/**
	 * @param forceDisplayItemBar the forceDisplayItemBar to set
	 */
