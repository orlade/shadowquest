...
public class WorldMap extends Map
{
	...
	public boolean isInTown(double x, double y)
	{
		...
		if(tx >= this.townTileStartX && tx < townTileStartX + townTilesWidth
				&& ty >= this.townTileStartY && ty < townTileStartY + townTilesHeight
				...
				&& !( tx == townTileStartX + townTilesWidth-1 && ty == townTileStartY + townTilesHeight-1 ) )
		{
			return true;
		}
		else
