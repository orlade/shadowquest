...
public class WorldWeapon extends WorldItem
{
     ...
     * @param minDamage The minimum damage dealt by the weapon
     * @param maxDamage The maximum damage dealt by the weapon 
     * @throws SlickException
     */
	public WorldWeapon(double x, double y, String name, Image avatar, ArrayList<Bonus> bonuses, double minDamage, double maxDamage)
	throws SlickException
	{
