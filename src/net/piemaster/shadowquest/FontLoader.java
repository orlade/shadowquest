...
public class FontLoader
{
	 ...
	 */
	public static Font loadFont(String ttf_filename, float textsize) throws SlickException
	{
		// First, load a java.awt.Font of the given TTF file
		java.awt.Font awtfont;
		try
		{
			awtfont = java.awt.Font.createFont(java.awt.Font.TRUETYPE_FONT, new File(ttf_filename));
		}
