...
/**
 * A bit of a hack class really... I needed some way to splice player/camera
 * repositioning in between the fade out and the fade in, so this class simply
 * calls its superclass to fade out, but throws in a call to the GPS (to
 * position the player/camera) before it starts.
 * 
 * @author Oliver
 * 
 */
