...
public class MonsterNecromancer extends Monster
{
	 ...
	 */
	public MonsterNecromancer(double x, double y, int level) throws SlickException
	{
	 ...
	 * @throws SlickException
	 */
	public MonsterNecromancer(double x, double y, String name, int level) throws SlickException
	{
		// Set the fundamental monster data
		super(x, y, level);
		this.name = name;
