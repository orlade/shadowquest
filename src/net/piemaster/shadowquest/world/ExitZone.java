...
public class ExitZone
{
	 ...
	 * 
	 * @param x
	 *            The x coordindate to create at
	 * @param y
	 *            The y coordindate to create at
	 * @param width
	 *            The widt of the zone
	 * @param height
	 *            The height of the zone
	 * @param targetId
	 *            The ID of the state the zone will jump to
	 */
	...
	public void renderMask(Graphics g, double cameraX, double cameraY)
	{
		...
		g.fillRect((float) (getX() - cameraX), (float) (getY() - cameraY), (float) getWidth(),
				(float) getHeight());
	}
	...
	{
		return "ExitZone [height=" + height + ", targetId=" + targetId + ", width=" + width
				+ ", x=" + x + ", y=" + y + "]";
	}
