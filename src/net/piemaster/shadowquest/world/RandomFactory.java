...
{
	public static WorldWeapon createWeapon(double x, double y, int mlvl) throws SlickException
	{
	...
	public static WorldArmour createArmour(double x, double y, int mlvl) throws SlickException
	{
	 ...
	 * 
	 * @param x
	 *            The x coord to spawn
	 * @param y
	 *            The y coord to spawn
	 * @param mlvl
	 *            The level of the monster dropping the item
	 * @param type
	 *            The Item type to drop
	...
	/**
	 * Returns some scalar value that represents the value of the monster given
	 * its mlvl This vlue is used to multiply bonus factors and determine bonus
	 * values.
	 * 
	 * @param mlvl
	 *            The level of the slain monster
